...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::SliderFloat("Reaching Distance", &f, 0.0f, 1000.0f);            // Edit 1 float using a slider from 0.0f to 1.0f
            ImGui::SliderInt("Iterations", &f, 0.0f, 1.0f);            // Edit 1 float using a slider from 0.0f to 1.0f
